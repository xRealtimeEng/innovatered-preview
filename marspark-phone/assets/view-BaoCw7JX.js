...
void main() {
    ...
    `})}function nu(m){let h=navigator.deviceMemory??8,g=navigator.hardwareConcurrency||8,_=window.matchMedia(`(pointer: coarse), (max-width: 900px)`).matches||g<=4||h<=4,v=_?1:1.35,y=new sl({canvas:m,antialias:!1,alpha:!1,depth:!0,stencil:!1,powerPreference:`low-power`,failIfMajorPerformanceCaveat:!1});y.setClearColor(13206618,1),y.setPixelRatio(Math.min(window.devicePixelRatio||1,v)),y.outputColorSpace=Ye,y.toneMapping=_?0:4,y.toneMappingExposure=1.16,y.shadowMap.enabled=!_,y.shadowMap.type=1;let b=new Dn;b.background=new q(13206618),b.fog=new En(13206618,_?10:14,_?28:42),_||(b.environment=new mo(y).fromScene(new cl,.04).texture);let x=new ma(46,1,.12,_?36:72);x.position.set(0,12,-18);let S=new W,C=new W,w=new W,T=_?null:new vl(y);if(T&&(T.addPass(new Cl(b,x)),T.addPass(new bl),T.addPass(new Sl)),!_){let e=new Y(new bi(220,28,16),tu());e.frustumCulled=!1,b.add(e)}b.add(new na(16774884,12081714,_?1.15:.85));let E=new ya(16774365,_?1.4:2.35);if(E.position.set(18,32,10),E.castShadow=!_,_||(E.shadow.mapSize.set(1024,1024),E.shadow.camera.near=4,E.shadow.camera.far=70,E.shadow.camera.left=-22,E.shadow.camera.right=22,E.shadow.camera.top=22,E.shadow.camera.bottom=-22,E.shadow.bias=-35e-5),b.add(E,E.target),!_){let e=new ya(10406911,.38);e.position.set(-16,12,-8),b.add(e);let t=new ga(16761466,3.4,18,1.5);t.position.set(0,2.7,-6.1),b.add(t);let n=new ga(10405119,2.4,9,1.7);n.position.set(0,2.4,.2),b.add(n)}let D=eu();D&&(D.wrapS=D.wrapT=p,D.repeat.set(10,10));let O=new Y(new pi(100,_?24:48),_?new Mr({color:13206618}):new Mi({color:16777215,map:D??void 0,roughness:.92,metalness:0}));O.rotation.x=-Math.PI/2,O.position.y=-.03,O.receiveShadow=!0,b.add(O);let k=$l();k&&(k.wrapS=k.wrapT=p,k.repeat.set(8,8));let A=new Y(new pi(i.r-.4,_?32:64),_?new Mr({color:16251903}):new Mi({color:16777215,map:k??void 0,roughness:.72,metalness:.02}));A.rotation.x=-Math.PI/2,A.position.set(i.x,.01,i.z),A.receiveShadow=!0,b.add(A);let ee=new Y(new pi(11.5,40),new Mi({color:16771e3,roughness:.55,metalness:.04}));ee.rotation.x=-Math.PI/2,ee.position.y=.02,ee.receiveShadow=!0,b.add(ee);let te=new Y(new di(l.hx*2-.9,.06,l.hz*2-.9),new Mi({color:16045194,roughness:.48,metalness:.05}));if(te.position.y=.04,te.receiveShadow=!0,b.add(te),!_){let e=new Y(new bi(i.r,40,20,0,Math.PI*2,0,Math.PI/2),new Mi({color:12970239,transparent:!0,opacity:.14,roughness:.05,metalness:.1,side:2,depthWrite:!1}));e.scale.y=.7,b.add(e);let t=new Y(new xi(i.r,.22,8,64),Q(12887412));t.rotation.x=Math.PI/2,t.position.y=.12,b.add(t)}let j=new Mi({color:4869717,roughness:.8,metalness:.05}),M=new Set;for(let e of u)for(let t=0;t<e.length-1;t++){let n=e[t],r=e[t+1],i=`${Math.round(n.x)},${Math.round(n.z)}:${Math.round(r.x)},${Math.round(r.z)}`;if(M.has(i))continue;M.add(i);let a=r.x-n.x,o=r.z-n.z,s=new Y(new di(2.5,.05,Math.hypot(a,o)||1),j);s.position.set((n.x+r.x)/2,.035,(n.z+r.z)/2),s.rotation.y=Math.atan2(a,o),s.receiveShadow=!0,b.add(s)}let N=[];for(let e of t){let t=Jl(e);b.add(t),e.shape===`box`&&N.push(t)}let ne=new Map,re=null;window.setTimeout(()=>{_||o(()=>import(`./physics-GnUtp5D6.js`).then(e=>e.domePhysics.boot(_).then(()=>e.domePhysics)),__vite__mapDeps([0,1,2])).then(e=>{re=e;for(let e of N)b.remove(e);N.length=0;for(let t of e.bricks){let e=Tl(t.color,t.hx,t.hy,t.hz,t.kind,_);e.position.set(t.x,t.y,t.z),ne.set(t.id,e),b.add(e)}}).catch(()=>{})},700);for(let e of a){let t=Yl();t.position.set(e.x,0,e.z),t.rotation.y=e.yaw,b.add(t)}for(let e of s){let t=new Y(new mi(.55,.62,.12,12),Q(16765184));t.position.set(e.x,.06,e.z),t.receiveShadow=!0,b.add(t)}if(!_){for(let[e,t,n,r]of[[-48,-34,10,16],[52,-30,12,18],[-42,40,11,15],[48,38,10,17],[6,-54,13,18],[-10,52,11,14]]){let i=Zl(n,r);i.position.set(e,0,t),b.add(i)}for(let[e,t]of[[27,20],[-28,18],[24,-26],[-26,-22]]){let n=Xl();n.position.set(e,0,t),b.add(n)}for(let[e,t]of[[-40,12],[38,14],[32,-32],[-22,-40],[8,44],[-44,-14]]){let n=Ql();n.position.set(e,0,t),b.add(n)}}let ie=[];for(let[e,t,n]of[[`DUSTPAN AVE`,7.6,-11.8],[`ALLEY PROMISE`,-8.4,12.2],[`COLLATERAL`,12.2,-8.2],[`IOU LANE`,-12.2,-8.6]]){let r=new Y(new mi(.06,.08,1.35,8),Q(7027242));r.position.set(t,.68,n),r.castShadow=!0;let i=Fl(e);i.position.set(t,1.55,n),ie.push(i),b.add(r,i)}let ae=jl();b.add(ae);let oe=Array.from({length:10},(e,t)=>{let n=Pl(t),i=r(t);return n.position.set(i.x,0,i.z),n.lookAt(0,.8,0),b.add(n),n}),se=f.map(e=>{let t=Pl(0,e.coat,e.hat);t.scale.setScalar(.92),t.position.set(e.x,0,e.z);let n=Fl(e.name);return t.add(n),b.add(t),{mesh:t,tag:n,...e}}),P=e.map((e,t)=>{let n=Pl(t+2);return b.add(n),{mesh:n,...e,phase:t*1.3}}),ce=new Y(new yi(.92,1,28),new Mr({color:3120708,transparent:!0,opacity:.45,side:2}));ce.rotation.x=-Math.PI/2,ce.visible=!1,b.add(ce);let le=new Y(new yi(.96,1,48),new Mr({color:14747136,transparent:!0,opacity:.35,side:2}));le.rotation.x=-Math.PI/2,le.visible=!1,b.add(le);let F=new Map,ue=[],de=new Map,fe=new Map,pe=[],me=new bi(.12,8,6),he=null,ge=!1,_e=d.earned,ve=0,ye=[],be=[],xe=new bi(.14,8,8),Se=[],Ce=new za,we=new U,Te=new W,Ee=new wr(new W(0,1,0),-.85);function De(){let e=window.visualViewport,t=Math.max(m.clientWidth||0,e?.width||0,window.innerWidth||0,320),n=Math.max(m.clientHeight||0,e?.height||0,window.innerHeight||0,480),r=Math.floor(t*y.getPixelRatio()),i=Math.floor(n*y.getPixelRatio());(m.width!==r||m.height!==i)&&(y.setSize(t,n,!1),T?.setPixelRatio(y.getPixelRatio()),T?.setSize(t,n)),x.aspect=t/Math.max(1,n),x.updateProjectionMatrix()}De();let Oe=new ResizeObserver(()=>De());Oe.observe(m.parentElement??m),window.addEventListener(`resize`,De),window.visualViewport?.addEventListener(`resize`,De);function ke(e,t,n,r,i){let a=Math.sin(d.time*n+r)*t,o=1-Math.exp(-14*i),s=(t,n)=>{let r=e.getObjectByName(t);r&&(r.rotation.x+=(n-r.rotation.x)*o)};s(`legL`,a),s(`legR`,-a),s(`armL`,-a*1.15),s(`armR`,a*1.15)}function Ae(e,t){let n=ue.find(n=>!n.visible&&n.userData.kind===e&&n.userData.armed===t);return n||(n=Ll(e,t),ue.push(n),b.add(n)),n.visible=!0,n}function je(e){ae.position.set(d.player.x,0,d.player.z);let t=-Math.sin(d.player.yaw),n=-Math.cos(d.player.yaw);ae.lookAt(d.player.x+t,0,d.player.z+n),ae.rotateZ(-d.player.lean);let r=Math.min(1,d.player.speed/6),i=1+Math.sin(d.time*14)*r*.1;ae.scale.set(1.06/i,i,1),ke(ae,r*1.05,11,0,e);let a=ae.getObjectByName(`plate`),o=ae.getObjectByName(`helm`),s=ae.getObjectByName(`beanie`),c=ae.getObjectByName(`poncho`),l=ae.getObjectByName(`star`),u=d.armor===`suit`;a&&(a.visible=d.armor===`plate`||d.armor===`star`),c&&(c.visible=d.armor===`poncho`),l&&(l.visible=d.armor===`star`||u),o&&(o.visible=u),s&&(s.visible=!u);let f=ae.userData.parka;f&&f.color.setHex(u?2375283:d.armor===`poncho`?15778126:14711346);let p=ae.getObjectByName(`weapon`);if(p&&he!==d.weapon){for(;p.children.length;)p.remove(p.children[0]);p.add(Bl(d.weapon)),he=d.weapon}let m=ae.getObjectByName(`offhand`);m&&!ge&&(m.add(zl()),ge=!0),m&&(m.visible=d.shieldOn);let h=d.weapon!==`pick`&&d.weapon!==`lasso`,g=ae.getObjectByName(`armL`),_=ae.getObjectByName(`armR`);if(g&&_&&(h?(g.rotation.x=.95,g.rotation.y=-.75,g.rotation.z=.9,_.rotation.x-=d.recoil*.5):(g.rotation.y=0,g.rotation.z=0,_.rotation.x-=d.recoil*.28)),p){let e=Math.sin(d.time*(r>.2?12:2.4))*(r>.2?.035:.018);p.position.set(h?.08:.02,-.34+e,.18-d.recoil*.2),p.rotation.set(-.2-d.recoil*.85,h?-.15:0,Math.sin(d.time*1.6)*.04)}ce.visible=d.holding>0&&d.phase===`play`,ce.position.set(d.player.x,.08,d.player.z),ce.scale.setScalar(d.holdRadius)}function Me(e){oe.forEach((t,n)=>{let r=n===d.miners&&d.minerFall>0;t.visible=n<d.miners||r,t.position.y=Math.sin(d.time*2.2+n)*.04,r&&(t.rotation.z=(1-d.minerFall)*1.2),t.visible&&ke(t,.35,3.2,n,e)});for(let t of se){let n=d.folkDead.has(t.id);if(t.mesh.visible=!n,n)continue;if(t.mesh.lookAt(d.player.x,.9,d.player.z),t.tag.lookAt(x.position),d.deputies.has(t.id)&&!t.mesh.userData.gun){let e=Bl(`revolver`);e.scale.setScalar(.65),e.position.set(.02,-.34,.14),t.mesh.getObjectByName(`armR`)?.add(e),t.mesh.userData.gun=e}let r=d.nearId===t.id,i=r?1.05+Math.sin(d.time*8)*.04:1;t.mesh.scale.setScalar(.92*i),ke(t.mesh,r?.45:.15,r?6:2,t.x,e)}P.forEach(t=>{let n=t.x+Math.cos(d.time*.35+t.phase)*1.3,r=t.z+Math.sin(d.time*.28+t.phase)*1.1;t.mesh.position.set(n,Math.abs(Math.sin(d.time*3+t.phase))*.08,r),t.mesh.lookAt(n+Math.sin(d.time*.35+t.phase),.8,r+Math.cos(d.time*.35+t.phase)),ke(t.mesh,.7,5,t.phase,e)});for(let e of ie)e.lookAt(x.position)}function I(e){let t=new Set;for(let n of d.enemies){if(!n.alive)continue;t.add(n.id);let r=F.get(n.id);r||(r=Ae(n.kind,n.armed),F.set(n.id,r));let i=n.kind===`leaper`?Math.abs(Math.sin(d.time*7+n.id))*1.35:n.kind===`sidewinder`?Math.abs(Math.sin(d.time*6+n.id))*.7:Math.abs(Math.sin(d.time*10+n.id))*.12;r.position.set(n.x,i,n.z);let a=u[n.path]??u[0];r.lookAt(n.huntX??a[Math.min(n.waypoint,a.length-1)].x,i+.4,n.huntZ??a[Math.min(n.waypoint,a.length-1)].z);let o=r.userData.base||1,s=1+Math.sin(d.time*(n.kind===`leaper`?14:10)+n.id)*.16;r.scale.set(o*1.08/s,o*s,o);let c=r.userData.bodyMat;c.emissive.setHex(n.flash>0?16777215:0),c.emissiveIntensity=n.flash>0?.65:0;let l=r.userData.legs,f=r.userData.arms,p=Math.sin(d.time*(n.kind===`leaper`?16:9)+n.id),m=1-Math.exp(-12*e);l.forEach((e,t)=>{let n=p*(t%2==0?1.05:-1.05);e.rotation.x+=(n-e.rotation.x)*m}),f.forEach((e,t)=>{let n=p*(t%2==0?-1.2:1.2);e.rotation.x+=(n-e.rotation.x)*m});let h=r.userData.bar,g=Math.max(.05,n.hp/n.maxHp);h.scale.x=g,h.position.x=(g-1)*.32,h.material.color.setHex(g<.35?14747136:3120708)}for(let[e,n]of F)if(!t.has(e)){for(let e=0;e<5;e++){let t=new Y(me,Q([14747136,16765184,1929192,3120708,16774888][e]));t.position.copy(n.position),t.position.y+=.8,b.add(t),pe.push({mesh:t,life:.45,v:new W((Math.random()-.5)*4,2+Math.random()*3,(Math.random()-.5)*4)})}n.visible=!1,F.delete(e)}}function Ne(){let e=new Set;for(let t of d.towers){e.add(t.pad);let n=de.get(t.pad);(!n||n.userData.type!==t.type)&&(n&&b.remove(n),n=Rl(t.type),n.userData.type=t.type,de.set(t.pad,n),b.add(n)),n.position.set(t.x,0,t.z);let r=Math.sin(d.time*2+t.pad)*.03;n.rotation.z=r;let i=n.getObjectByName(`turret`);i&&i.lookAt(t.aimX,n.userData.height??3,t.aimZ)}for(let[t,n]of de)e.has(t)||(b.remove(n),de.delete(t));let t=0,r=0,i=0;if(d.selected!=null&&d.phase!==`title`){let e=s[d.selected],a=d.towers.find(e=>e.pad===d.selected),o=a?.type??d.ghost;e&&o&&(t=a?c(o,a.trickLvl):n[o].range,r=e.x,i=e.z)}le.visible=t>0,t>0&&(le.position.set(r,.12,i),le.scale.setScalar(t))}function Pe(){let e=new Set;for(let t of d.pickups){if(!t.alive)continue;e.add(t.id);let n=fe.get(t.id);n||(n=new vn,n.add(t.kind===`franklin`?Ul():Wl()),fe.set(t.id,n),b.add(n));let r=.55+Math.sin(d.time*4+t.id)*.16;n.position.set(t.x,r,t.z),n.rotation.y=d.time*2.2+t.id,n.rotation.z=Math.sin(d.time*3+t.id)*.3}for(let[t,n]of fe)e.has(t)||(b.remove(n),fe.delete(t))}function Fe(e){if(d.spray.id!==ve){ve=d.spray.id;let e=_?Math.min(8,Math.max(4,d.spray.n)):Math.min(16,Math.max(8,d.spray.n));for(let t=0;t<e;t++){let e=Ul();e.position.set(d.spray.x,1.15+Math.random()*.4,d.spray.z),b.add(e),ye.push({mesh:e,life:1.15+Math.random()*.4,vy:3.2+Math.random()*2.4,vx:(Math.random()-.5)*5.5,vz:(Math.random()-.5)*5.5})}}d.earned>_e&&d.phase===`play`&&d.spray.id,_e=d.earned;for(let t=ye.length-1;t>=0;t--){let n=ye[t];n.life-=e,n.vy-=e*3,n.mesh.position.x+=n.vx*e,n.mesh.position.y+=n.vy*e,n.mesh.position.z+=n.vz*e,n.mesh.rotation.x+=e*6,n.life<=0&&(b.remove(n.mesh),ye.splice(t,1))}for(let t=pe.length-1;t>=0;t--){let n=pe[t];n.life-=e,n.v.y-=e*8,n.mesh.position.addScaledVector(n.v,e),n.mesh.scale.setScalar(Math.max(.2,n.life*2)),n.life<=0&&(b.remove(n.mesh),pe.splice(t,1))}}function L(){let e=0;for(let t of d.shots){if(!t.alive)continue;let n=be[e];n||(n=new Y(xe,new Mi({color:16777215,roughness:.3,metalness:.2,emissive:2236962})),b.add(n),be[e]=n),n.visible=!0,n.position.set(t.x,t.y,t.z),n.material.color.setHex(t.color),n.material.emissive.setHex(t.color),n.scale.setScalar(t.hostile?.7:t.splash>0?1.5:.8),e++}for(;e<be.length;e++)be[e].visible=!1}function Ie(){let e=0;for(let t of d.fxPool){if(t.life<=0)continue;let n=Se[e];n||(n=new Y(new bi(.25,8,6),new Mr({color:16777215,transparent:!0,opacity:1})),Se[e]=n,b.add(n)),n.visible=!0;let r=t.life/t.max;n.position.set(t.x,t.y,t.z),n.scale.setScalar(t.kind===`boom`?(1-r)*2.4+.3:.4);let i=n.material;i.color.setHex(t.color),i.opacity=Math.max(0,r),e++}for(;e<Se.length;e++)Se[e].visible=!1}function R(e){let t=-Math.sin(d.camYaw),n=-Math.cos(d.camYaw),r=Math.cos(d.camYaw),i=-Math.sin(d.camYaw),a=Math.abs(d.player.x)<5.6&&Math.abs(d.player.z)<4.6,o=a?8.4:11.4,s=2.2,c=(a?9.4:7.3)-d.camPitch*.35;S.set(d.player.x-t*o+r*s,c,d.player.z-n*o+i*s),C.set(d.player.x+t*1.5,1.35,d.player.z+n*1.5),d.snapCam?(x.position.copy(S),d.snapCam=!1):x.position.lerp(S,1-Math.exp(-11*e));let l=d.shake*.18;w.set(Math.sin(d.time*47)*l,Math.cos(d.time*37)*l*.5,0),x.position.add(w),x.lookAt(C)}let z=!1;function Le(e){let t=d.time*.12;S.set(Math.sin(t)*16,12,Math.cos(t)*16-6),C.set(0,1.5,0),z?x.position.lerp(S,1-Math.exp(-1.1*e)):(x.position.copy(S),z=!0),x.lookAt(C)}function Re(){let e=m.getBoundingClientRect();d.qaKeys==null&&d.mouseAim&&!d.coarseAim&&e.width>0&&e.height>0?(we.x=(d.mouseX-e.left)/e.width*2-1,we.y=-((d.mouseY-e.top)/e.height)*2+1):we.set(0,0),Ce.setFromCamera(we,x),Ce.ray.intersectPlane(Ee,Te)&&(d.aimX=Te.x,d.aimZ=Te.z,d.hasAim=!0)}return{sync(e){if(De(),je(e),Me(e),I(e),Ne(),Pe(),Fe(e),L(),Ie(),re?.ready){re.step(e);for(let e of re.bricks){let t=ne.get(e.id);t&&(t.position.set(e.x,e.y,e.z),t.quaternion.set(e.qx,e.qy,e.qz,e.qw))}}_||(E.position.set(d.player.x+16,28,d.player.z+8),E.target.position.set(d.player.x,0,d.player.z),E.target.updateMatrixWorld()),d.phase===`title`?Le(e):R(e),Re(),T?T.render():y.render(b,x)},dispose(){Oe.disconnect(),window.removeEventListener(`resize`,De),window.visualViewport?.removeEventListener(`resize`,De),T?.dispose(),y.dispose()}}}export{nu as createView};