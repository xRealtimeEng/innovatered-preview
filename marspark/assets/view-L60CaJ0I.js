...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function yo(e,t,n){return new Ai({name:`SphericalGaussianBlur`,defines:{SAMPLES:ro,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:So(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bo(){return new Ai({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:So(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xo(){return new Ai({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:So(),fragmentShader:`
	...
	`}var Co=class extends Bt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},dl=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},fl=new _a(-1,1,1,-1,0,1),pl=new class extends br{constructor(){super(),this.setAttribute(`position`,new J([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new J([0,2,0,0,2,0],2))}},ml=class{constructor(e){this._mesh=new Y(pl,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,fl)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},hl=class extends dl{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Ai?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Di.clone(e.uniforms),this.material=new Ai({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new ml(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},gl=class extends dl{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},_l=class extends dl{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},vl=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new U);this._width=n.width,this._height=n.height,t=new Bt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:k}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new hl(ul),this.copyPass.material.blending=0,this.timer=new wa}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}gl!==void 0&&(r instanceof gl?n=!0:r instanceof _l&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new U);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},yl={name:`FXAAShader`,uniforms:{tDiffuse:{value:null},resolution:{value:new U(1/1024,1/512)}},vertexShader:`
		...
		}`},bl=class extends hl{constructor(){super(yl)}setSize(e,t){this.material.uniforms.resolution.value.set(1/e,1/t)}},xl={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Sl=class extends dl{constructor(){super(),this.isOutputPass=!0,this.uniforms=Di.clone(xl.uniforms),this.material=new ji({name:xl.name,uniforms:this.uniforms,vertexShader:xl.vertexShader,fragmentShader:xl.fragmentShader}),this._fsQuad=new ml(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},K.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Cl=class extends dl{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new q}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},wl=new Map;function Q(e){let t=wl.get(e);return t||(t=new Mi({color:e,roughness:.32,metalness:.08}),wl.set(e,t)),t}function Tl(e,t,n,r,i,a){let o=new vn,s=$(new di(t*2,n*2,r*2),Q(e));if(o.add(s),i!==`window`){let i=a?1:Math.min(3,Math.max(1,Math.round(t*2/.32))),s=a?1:Math.min(3,Math.max(1,Math.round(r*2/.32))),c=new mi(.07,.07,.06,8),l=Q(e),u=t*2*.62,d=r*2*.62;for(let e=0;e<s;e++)for(let t=0;t<i;t++){let r=$(c,l,!1),a=i===1?0:-u/2+u*t/Math.max(1,i-1),f=s===1?0:-d/2+d*e/Math.max(1,s-1);r.position.set(a,n+.03,f),o.add(r)}}if(i===`window`){let e=$(new di(t*1.4,n*1.2,.04),Q(10405119),!1);e.position.set(0,0,r+.01),o.add(e)}if(i===`door`){let e=$(new bi(.04,6,6),Q(16765184),!1);e.position.set(t*.45,0,r+.04),o.add(e)}return o}function $(e,t,n=!0){let r=new Y(e,t);return r.castShadow=n,r.receiveShadow=n,r}function El(e,t,n,r=!0){return $(new fi(e,t,2,8),n,r)}function Dl(e,t=.26){let n=Q(16776696),r=Q(1709844),i=Q(15769760);for(let i of[-.09,.09]){let a=$(new bi(.055,10,8),n,!1);a.position.set(i,.04,t);let o=$(new bi(.028,8,6),r,!1);o.position.set(i*1.05,.03,t+.04),e.add(a,o)}let a=$(new xi(.07,.016,6,12,Math.PI),r,!1);a.rotation.z=Math.PI,a.position.set(0,-.07,t+.01),e.add(a);for(let n of[-.16,.16]){let r=$(new bi(.04,8,6),i,!1);r.scale.set(1,.7,.4),r.position.set(n,-.02,t-.02),e.add(r)}}function Ol(e,t,n,r){let i=new vn;i.position.set(e,t,0);let a=$(new bi(.09,10,8),n,!1),o=El(.075,r,n);o.position.y=-r*.55-.06;let s=$(new bi(.09,8,6),n,!1);return s.scale.set(1.35,.55,1.55),s.position.y=-r-.12,i.add(a,o,s),i}function kl(e,t,n){let r=new vn;r.position.set(e,t,0);let i=$(new bi(.08,8,6),n,!1),a=El(.06,.22,n);a.position.y=-.2;let o=$(new bi(.08,8,6),Q(15976353),!1);return o.position.y=-.38,r.add(i,a,o),r}function Al(e,t,n){let r=new vn;if(r.name=`hat`,e===`none`)return r;let i=Q(t);if(e===`cowboy`){let e=$(new mi(.34,.34,.05,16),i,!1);e.position.y=n;let t=$(new mi(.16,.18,.2,12),i,!1);t.position.y=n+.14,r.add(e,t)}else if(e===`top`){let e=$(new mi(.3,.3,.05,14),Q(1709844),!1);e.position.y=n;let t=$(new mi(.16,.16,.32,12),Q(1709844),!1);t.position.y=n+.2,r.add(e,t)}else{let e=$(new mi(.28,.3,.08,14),i,!1);e.position.y=n;let t=$(new bi(.08,8,6),i,!1);t.position.y=n+.16,r.add(e,t)}return r}function jl(){let e=new vn,t=plasticUnique(14711346),n=Q(1920649),r=Q(15976353),i=Ol(-.16,.62,n,.34),a=Ol(.16,.62,n,.34);i.name=`legL`,a.name=`legR`;let o=$(new mi(.28,.32,.52,14),t);o.position.y=.86,o.name=`torso`;let s=$(new mi(.08,.08,.08,8),r,!1);s.position.y=1.16;let c=kl(-.38,1.02,t),l=kl(.38,1.02,t);c.name=`armL`,l.name=`armR`;let u=$(new bi(.32,18,14),r);u.position.y=1.42,u.name=`head`,Dl(u,.26);let d=Al(`cap`,1929192,1.68);d.name=`beanie`;let f=$(new di(.62,.36,.4),Q(12887412));f.name=`plate`,f.position.set(0,.88,.04),f.visible=!1;let p=new vn;p.name=`poncho`;let m=$(new di(.86,.08,.62),Q(14747136));m.position.y=1.08,m.rotation.x=.35;let h=$(new di(.88,.04,.16),Q(16774888),!1);h.position.set(0,1.1,.08),h.rotation.x=.35,p.add(m,h),p.visible=!1;let g=$(new _i(.11,0),Q(16765184),!1);g.scale.set(1,1,.35),g.name=`star`,g.position.set(.14,.98,.28),g.visible=!1;let _=Al(`top`,1709844,1.7);_.name=`helm`,_.visible=!1;let v=new vn;v.name=`weapon`,v.position.set(.02,-.36,.16),l.add(v);let y=new vn;return y.name=`offhand`,y.position.set(-.02,-.36,.12),c.add(y),e.add(i,a,o,s,c,l,u,d,f,p,g,_),e.userData.parka=t,e.userData.base=1,e}var Ml=[14747136,1929192,3120708,16765184,8014773,12876338,15759922,4030153],Nl=[1929192,14747136,3120708,16765184,1709844,8014773,12876338,7027242];function Pl(e,t,n){let r=new vn,i=Q(t??Ml[e%Ml.length]),a=Q(2375283),o=Q(15976353),s=Ol(-.13,.52,a,.28),c=Ol(.13,.52,a,.28);s.name=`legL`,c.name=`legR`;let l=$(new mi(.22,.26,.42,12),i);l.position.y=.72;let u=kl(-.3,.86,i),d=kl(.3,.86,i);u.name=`armL`,d.name=`armR`;let f=$(new bi(.26,14,12),o);return f.position.y=1.16,f.name=`head`,Dl(f,.21),r.add(s,c,l,u,d,f,Al(`cowboy`,n??Nl[e%Nl.length],1.36)),r.userData.base=.86,r.scale.setScalar(.86),r}function Fl(e){let t=document.createElement(`canvas`);t.width=256,t.height=64;let n=t.getContext(`2d`);if(!n)return new vn;n.fillStyle=`#fff6e8`,n.fillRect(0,0,256,64),n.strokeStyle=`#1a1714`,n.lineWidth=8,n.strokeRect(4,4,248,56),n.fillStyle=`#1a1714`,n.font=`800 28px Arial Black, Arial, sans-serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,128,34);let r=new si(t),i=new Y(new vi(1.15,.3),new Mr({map:r,transparent:!0,side:2}));return i.name=`tag`,i.position.y=1.85,i}function Il(e){let t=$(new di(.7,.07,.04),Q(1709844),!1);t.position.y=e;let n=$(new di(.64,.045,.05),Q(3120708),!1);return n.position.y=e,n.name=`hp`,{back:t,bar:n}}function Ll(e,t){let n=new vn,r=[],i=[],a=plasticUnique(12887412),o=1,s=Q(15976353),c=(e,t,o=!1)=>{a=plasticUnique(e);let c=$(new mi(o?.2:.26,o?.24:.3,o?.62:.48,12),a);c.position.y=o?.95:.78;let l=$(new bi(o?.28:.26,14,12),s);l.position.y=o?1.48:1.22,Dl(l,o?.23:.21);let u=Al(`cowboy`,t,o?1.7:1.42),d=Ol(o?-.12:-.14,o?.62:.52,Q(3814704),o?.42:.3),f=Ol(o?.12:.14,o?.62:.52,Q(3814704),o?.42:.3),p=kl(o?-.28:-.34,o?1.1:.92,a),m=kl(o?.28:.34,o?1.1:.92,a);r.push(d,f),i.push(p,m);let h=Il(o?2.05:1.7);n.add(c,l,u,d,f,p,m,h.back,h.bar),n.userData.bar=h.bar};if(e===`boss`){a=plasticUnique(16773590);let e=$(new bi(.62,16,12),a);e.position.y=1.05,e.scale.set(1.15,.95,1);let t=$(new bi(.34,14,12),s);t.position.y=1.85,Dl(t,.28);let c=$(new di(.12,.4,.06),Q(14747136),!1);c.position.set(0,.9,.5);let l=kl(-.7,1.15,a),u=kl(.7,1.15,a),d=Ol(-.28,.55,Q(3814704),.36),f=Ol(.28,.55,Q(3814704),.36);r.push(d,f),i.push(l,u);let p=Il(2.45);n.add(e,t,c,Al(`cowboy`,14747136,2.12),l,u,d,f,p.back,p.bar),n.userData.bar=p.bar,o=1.45}else e===`brute`?(c(7172730,1709844),o=1.25):e===`leaper`?(c(16765184,14747136,!0),o=1):e===`sidewinder`?(c(14747136,1709844,!0),o=1.05):e===`posse`?(c(12876338,7027242),o=1.05):c(12887412,7027242);if(t){let e=$(new di(.08,.08,.36),Q(1709844),!1);e.position.set(.34,.85,.28),e.name=`gun`,n.add(e)}return n.userData.bodyMat=a,n.userData.legs=r,n.userData.arms=i,n.userData.kind=e,n.userData.armed=t,n.userData.base=o,n.scale.setScalar(o),n}function Rl(e){let t=n[e],r=new vn,i=t.height,a=$(new mi(.72,.85,.35,12),Q(12887412));a.position.y=.18;let o=$(new mi(.28,.38,i-.8,10),Q(t.color));o.position.y=i*.45;let s=$(new mi(.7,.7,.16,14),Q(16774888));s.position.y=i-.35;let c=new mi(.035,.035,.45,6);for(let e=0;e<6;e++){let t=e/6*Math.PI*2,n=$(c,Q(1709844),!1);n.position.set(Math.cos(t)*.58,i-.05,Math.sin(t)*.58),r.add(n)}let l=new vn;l.name=`turret`,l.position.y=i-.15;let u=e===`glue`?1929192:e===`confetti`?14747136:e===`disco`?16765184:2764340,d=$(new mi(.1,.12,.7,8),Q(u),!1);if(d.rotation.x=Math.PI/2,d.position.z=.35,l.add(d),e===`honk`){let e=$(new hi(.22,.4,8),Q(16765184),!1);e.rotation.x=Math.PI/2,e.position.z=.7,l.add(e)}if(e===`disco`){let e=$(new bi(.22,12,10),Q(16774888),!1);e.position.y=.35,l.add(e)}return r.add(a,o,s,l),r.userData.height=i,r}function zl(){let e=new vn;e.name=`shield`;let t=$(new mi(.28,.3,.06,16),Q(12887412),!1);t.rotation.x=Math.PI/2;let n=$(new xi(.3,.03,6,16),Q(16765184),!1);n.rotation.x=Math.PI/2;let r=$(new bi(.06,8,6),Q(1709844),!1);return r.position.z=.04,e.add(t,n,r),e}function Bl(e){let t=new vn;if(e===`pick`){let e=El(.045,.7,Q(7027242),!1);e.rotation.x=Math.PI/2,e.position.z=.2,t.add(e)}else if(e===`lasso`){let e=$(new xi(.22,.035,6,14),Q(14747136),!1);e.position.z=.35,t.add(e)}else if(e===`carbine`){let e=$(new di(.1,.12,.72),Q(1929192),!1);e.position.z=.2,t.add(e)}else if(e===`revolver`){let e=$(new di(.1,.12,.42),Q(12887412),!1);e.position.z=.16;let n=$(new di(.08,.16,.1),Q(1709844),!1);n.position.set(0,-.12,.02),t.add(e,n)}else if(e===`dynamite`){let e=El(.07,.28,Q(14747136),!1);e.rotation.x=Math.PI/2,e.position.z=.2;let n=$(new mi(.02,.02,.16,6),Q(16765184),!1);n.position.set(.08,.08,.32),t.add(e,n)}else{let e=El(.1,.45,Q(3120708),!1);e.rotation.x=Math.PI/2,e.position.z=.25,t.add(e)}return t}function Vl(e,t,n){let r=document.createElement(`canvas`);r.width=t,r.height=n;let i=r.getContext(`2d`);if(!i)return null;e(i,t,n);let a=new si(r);return a.colorSpace=Ye,a.anisotropy=4,a}function Hl(){return Vl((e,t,n)=>{e.fillStyle=`#e7f6ea`,e.fillRect(0,0,t,n),e.strokeStyle=`#1a1714`,e.lineWidth=10,e.strokeRect(8,8,t-16,n-16),e.fillStyle=`#178a45`,e.font=`800 64px Arial Black, Arial, sans-serif`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(`100`,t/2,n/2-8),e.font=`700 22px Arial, sans-serif`,e.fillText(`MARSBUCK`,t/2,n/2+36)},256,128)}function Ul(){let e=Hl();return new Y(new vi(.62,.31),new Mi({map:e??void 0,color:16777215,roughness:.6,metalness:0,side:2}))}function Wl(){let e=new vn;e.add($(new di(.42,.36,.42),Q(12876338)));let t=$(new di(.46,.08,.46),Q(16765184),!1);return t.position.y=.22,e.add(t),e}function Gl(e,t=1.4,n=.46){let r=Vl((t,n,r)=>{t.fillStyle=`#fff6e8`,t.fillRect(0,0,n,r),t.strokeStyle=`#1a1714`,t.lineWidth=12,t.strokeRect(8,8,n-16,r-16),t.fillStyle=`#e10600`,t.font=`800 42px Arial Black, Arial, sans-serif`,t.textAlign=`center`,t.textBaseline=`middle`,t.fillText(e,n/2,r/2+2)},256,96);return new Y(new vi(t,n),new Mr({map:r??void 0,color:16777215,side:2}))}function Kl(e,t){return Vl((n,r,i)=>{n.fillStyle=e,n.fillRect(0,0,r,i);for(let e=0;e<80;e++)n.fillStyle=`rgba(255,255,255,0.05)`,n.fillRect(Math.random()*r,Math.random()*i,18,8);n.strokeStyle=`rgba(26,23,20,0.35)`,n.lineWidth=8;for(let e=0;e<3;e++)for(let t=0;t<2;t++){let r=40+t*110,i=36+e*90;n.fillStyle=`#9fd4ff`,n.fillRect(r,i,70,58),n.strokeRect(r,i,70,58),n.beginPath(),n.moveTo(r+35,i),n.lineTo(r+35,i+58),n.moveTo(r,i+29),n.lineTo(r+70,i+29),n.stroke()}n.fillStyle=`#fff6e8`,n.fillRect(r/2-90,18,180,40),n.strokeRect(r/2-90,18,180,40),n.fillStyle=`#1a1714`,n.font=`800 28px Arial Black, Arial, sans-serif`,n.textAlign=`center`,n.fillText(t,r/2,46)},512,512)}function ql(e){return`#${e.toString(16).padStart(6,`0`)}`}function Jl(e){let t=new vn;if(e.shape===`vault`){let n=$(new di(e.hw*2,e.h,e.hd*2),Q(e.color));n.position.y=e.h/2;let r=$(new mi(.55,.55,.12,16),Q(16765184));r.rotation.x=Math.PI/2,r.position.set(0,e.h*.55,-(e.hd+.04));let i=$(new xi(.22,.05,6,12),Q(1709844),!1);i.position.set(0,e.h*.55,-(e.hd+.12));let a=$(new di(e.hw*2+.2,.16,e.hd*2+.2),Q(e.roof));a.position.y=e.h+.05,t.add(n,r,i,a)}else if(e.shape===`bunker`){let n=$(new di(e.hw*2,e.h,e.hd*2),Q(e.color));n.position.y=e.h/2;let r=$(new di(e.hw*2+.15,.16,e.hd*2+.15),Q(2380328));r.position.y=e.h+.02;let i=$(new di(e.hw*1.2,.12,.08),Q(1709844),!1);i.position.set(0,e.h*.62,e.hd+.02),t.add(n,r,i)}else if(e.shape===`wall`){let n=$(new di(e.hw*2,e.h,e.hd*2),Q(e.color));n.position.y=e.h/2;let r=$(new di(e.hw*2+.12,.16,e.hd*2+.12),Q(e.roof));if(r.position.y=e.h+.02,t.add(n,r),e.sign){let n=Gl(e.sign,1.6,.48);n.position.set(0,e.h*.62,-(e.hd+.06)),n.rotation.y=Math.PI,t.add(n)}}else if(e.shape===`tank`){let n=$(new mi(e.hw,e.hw,e.h,16),Q(e.color));n.position.y=e.h/2;let r=$(new mi(e.hw+.15,e.hw+.15,.18,16),Q(16774888));r.position.y=e.h+.05,t.add(n,r)}else{let n=new Mi({color:16777215,map:Kl(ql(e.color),e.sign??`SHOP`)??void 0,roughness:.45,metalness:.04}),r=$(new di(e.hw*2,e.h,e.hd*2),n);r.position.y=e.h/2;let i=$(new di(e.hw*2+.4,.28,e.hd*2+.35),Q(e.roof));i.position.y=e.h+.1;let a=$(new di(e.hw*2+.15,.1,e.hd*2+.12),Q(16774888),!1);a.position.y=e.h-.02,t.add(r,i,a)}return t.position.set(e.x,0,e.z),t}function Yl(){let e=new vn,t=Q(12887412);for(let n=0;n<3;n++){let r=El(.16,.28,t);r.rotation.z=Math.PI/2,r.position.set((n-1)*.34,.2+(n===1?.22:0),0),e.add(r)}return e}function Xl(){let e=new vn,t=El(.1,.4,Q(7027242));t.position.y=.4;let n=$(new hi(.7,1.1,8),Q(3120708));n.position.y=1.15;let r=$(new hi(.48,.85,8),Q(3981144));return r.position.y=1.85,e.add(t,n,r),e}function Zl(e,t){let n=new vn,r=$(new hi(e,t*.7,7),Q(12868146),!1);r.position.y=t*.28;let i=$(new hi(e*.45,t*.38,7),Q(16774888),!1);return i.position.y=t*.62,n.add(r,i),n}function Ql(){let e=new vn,t=Q(3120708),n=El(.22,1.1,t);n.position.y=.8;let r=El(.12,.45,t);return r.rotation.z=Math.PI/2,r.position.set(.4,1.05,0),e.add(n,r),e}function $l(){return Vl((e,t,n)=>{e.fillStyle=`#f7fbff`,e.fillRect(0,0,t,n);for(let r=0;r<1400;r++){let r=Math.random();e.fillStyle=r>.7?`#d5e6f5`:`#ffffff`,e.beginPath(),e.arc(Math.random()*t,Math.random()*n,r>.85?3:1.4,0,Math.PI*2),e.fill()}},512,512)}function eu(){return Vl((e,t,n)=>{e.fillStyle=`#c4623c`,e.fillRect(0,0,t,n);for(let r=0;r<900;r++)e.fillStyle=Math.random()>.5?`#a84b2e`:`#e08a5c`,e.fillRect(Math.random()*t,Math.random()*n,4,3)},512,512)}function tu(){return new Ai({side:1,depthWrite:!1,fog:!1,vertexShader:`
      varying vec3 vWorld;
      void main() {
    ...
    `,fragmentShader:`
      ...
      void main() {
        ...
        vec3 mid = vec3(0.93, 0.55, 0.38);
        vec3 hor = vec3(0.78, 0.32, 0.22);
        vec3 col = mix(hor, mid, smoothstep(0.0, 0.18, h));
        col = mix(col, top, smoothstep(0.18, 0.72, h));
        gl_FragColor = vec4(col, 1.0);
      }
    `})}function nu(m){let h=navigator.deviceMemory??8,g=navigator.hardwareConcurrency||8,_=window.matchMedia(`(pointer: coarse), (max-width: 900px)`).matches||g<=4||h<=4,v=_?1:1.35,y=new sl({canvas:m,antialias:!1,alpha:!1,depth:!0,stencil:!1,powerPreference:`low-power`,failIfMajorPerformanceCaveat:!1});y.setClearColor(13206618,1),y.setPixelRatio(Math.min(window.devicePixelRatio||1,v)),y.outputColorSpace=Ye,y.toneMapping=_?0:4,y.toneMappingExposure=1.16,y.shadowMap.enabled=!_,y.shadowMap.type=1;let b=new Dn;b.background=new q(13206618),b.fog=new En(13206618,14,42),_||(b.environment=new mo(y).fromScene(new cl,.04).texture);let x=new ma(46,1,.12,72);x.position.set(0,12,-18);let S=new W,C=new W,w=new W,T=_?null:new vl(y);T&&(T.addPass(new Cl(b,x)),T.addPass(new bl),T.addPass(new Sl));let E=new Y(new bi(220,_?16:28,_?10:16),tu());E.frustumCulled=!1,b.add(E),b.add(new na(16774884,12081714,.85));let D=new ya(16774365,2.35);D.position.set(18,32,10),D.castShadow=!_,_||(D.shadow.mapSize.set(1024,1024),D.shadow.camera.near=4,D.shadow.camera.far=70,D.shadow.camera.left=-22,D.shadow.camera.right=22,D.shadow.camera.top=22,D.shadow.camera.bottom=-22,D.shadow.bias=-35e-5),b.add(D,D.target);let O=new ya(10406911,_?.55:.38);if(O.position.set(-16,12,-8),b.add(O),!_){let e=new ga(16761466,3.4,18,1.5);e.position.set(0,2.7,-6.1),b.add(e);let t=new ga(10405119,2.4,9,1.7);t.position.set(0,2.4,.2),b.add(t)}let k=eu();k&&(k.wrapS=k.wrapT=p,k.repeat.set(10,10));let A=new Y(new pi(100,_?24:48),_?new Mr({color:13206618}):new Mi({color:16777215,map:k??void 0,roughness:.92,metalness:0}));A.rotation.x=-Math.PI/2,A.position.y=-.03,A.receiveShadow=!0,b.add(A);let ee=$l();ee&&(ee.wrapS=ee.wrapT=p,ee.repeat.set(8,8));let te=new Y(new pi(i.r-.4,_?32:64),_?new Mr({color:16251903}):new Mi({color:16777215,map:ee??void 0,roughness:.72,metalness:.02}));te.rotation.x=-Math.PI/2,te.position.set(i.x,.01,i.z),te.receiveShadow=!0,b.add(te);let j=new Y(new pi(11.5,40),new Mi({color:16771e3,roughness:.55,metalness:.04}));j.rotation.x=-Math.PI/2,j.position.y=.02,j.receiveShadow=!0,b.add(j);let M=new Y(new di(l.hx*2-.9,.06,l.hz*2-.9),new Mi({color:16045194,roughness:.48,metalness:.05}));M.position.y=.04,M.receiveShadow=!0,b.add(M);let N=new Y(new bi(i.r,_?24:40,_?12:20,0,Math.PI*2,0,Math.PI/2),new Mi({color:12970239,transparent:!0,opacity:.14,roughness:.05,metalness:.1,side:2,depthWrite:!1}));N.scale.y=.7,b.add(N);let ne=new Y(new xi(i.r,.22,8,_?32:64),Q(12887412));ne.rotation.x=Math.PI/2,ne.position.y=.12,b.add(ne);let re=new Mi({color:4869717,roughness:.8,metalness:.05}),ie=new Set;for(let e of u)for(let t=0;t<e.length-1;t++){let n=e[t],r=e[t+1],i=`${Math.round(n.x)},${Math.round(n.z)}:${Math.round(r.x)},${Math.round(r.z)}`;if(ie.has(i))continue;ie.add(i);let a=r.x-n.x,o=r.z-n.z,s=new Y(new di(2.5,.05,Math.hypot(a,o)||1),re);s.position.set((n.x+r.x)/2,.035,(n.z+r.z)/2),s.rotation.y=Math.atan2(a,o),s.receiveShadow=!0,b.add(s)}let ae=[];for(let e of t){let t=Jl(e);b.add(t),e.shape===`box`&&ae.push(t)}let oe=new Map,se=null;window.setTimeout(()=>{o(()=>import(`./physics-B2QLIp1a.js`).then(e=>e.domePhysics.boot(_).then(()=>e.domePhysics)),__vite__mapDeps([0,1,2])).then(e=>{se=e;for(let e of ae)b.remove(e);ae.length=0;for(let t of e.bricks){let e=Tl(t.color,t.hx,t.hy,t.hz,t.kind,_);e.position.set(t.x,t.y,t.z),oe.set(t.id,e),b.add(e)}}).catch(()=>{})},700);for(let e of a){let t=Yl();t.position.set(e.x,0,e.z),t.rotation.y=e.yaw,b.add(t)}for(let e of s){let t=new Y(new mi(.55,.62,.12,12),Q(16765184));t.position.set(e.x,.06,e.z),t.receiveShadow=!0,b.add(t)}for(let[e,t,n,r]of[[-48,-34,10,16],[52,-30,12,18],[-42,40,11,15],[48,38,10,17],[6,-54,13,18],[-10,52,11,14]]){let i=Zl(n,r);i.position.set(e,0,t),b.add(i)}for(let[e,t]of[[27,20],[-28,18],[24,-26],[-26,-22]]){let n=Xl();n.position.set(e,0,t),b.add(n)}for(let[e,t]of[[-40,12],[38,14],[32,-32],[-22,-40],[8,44],[-44,-14]]){let n=Ql();n.position.set(e,0,t),b.add(n)}let P=[];for(let[e,t,n]of[[`DUSTPAN AVE`,7.6,-11.8],[`ALLEY PROMISE`,-8.4,12.2],[`COLLATERAL`,12.2,-8.2],[`IOU LANE`,-12.2,-8.6]]){let r=new Y(new mi(.06,.08,1.35,8),Q(7027242));r.position.set(t,.68,n),r.castShadow=!0;let i=Fl(e);i.position.set(t,1.55,n),P.push(i),b.add(r,i)}let F=jl();b.add(F);let ce=Array.from({length:10},(e,t)=>{let n=Pl(t),i=r(t);return n.position.set(i.x,0,i.z),n.lookAt(0,.8,0),b.add(n),n}),le=f.map(e=>{let t=Pl(0,e.coat,e.hat);t.scale.setScalar(.92),t.position.set(e.x,0,e.z);let n=Fl(e.name);return t.add(n),b.add(t),{mesh:t,tag:n,...e}}),ue=e.map((e,t)=>{let n=Pl(t+2);return b.add(n),{mesh:n,...e,phase:t*1.3}}),de=new Y(new yi(.92,1,28),new Mr({color:3120708,transparent:!0,opacity:.45,side:2}));de.rotation.x=-Math.PI/2,de.visible=!1,b.add(de);let fe=new Y(new yi(.96,1,48),new Mr({color:14747136,transparent:!0,opacity:.35,side:2}));fe.rotation.x=-Math.PI/2,fe.visible=!1,b.add(fe);let pe=new Map,me=[],he=new Map,ge=new Map,_e=[],ve=new bi(.12,8,6),ye=null,be=!1,xe=d.earned,Se=0,Ce=[],we=[],Te=new bi(.14,8,8),Ee=[],De=new za,Oe=new U,ke=new W,Ae=new wr(new W(0,1,0),-.85);function je(){let e=window.visualViewport,t=Math.max(m.clientWidth||0,e?.width||0,window.innerWidth||0,320),n=Math.max(m.clientHeight||0,e?.height||0,window.innerHeight||0,480),r=Math.floor(t*y.getPixelRatio()),i=Math.floor(n*y.getPixelRatio());(m.width!==r||m.height!==i)&&(y.setSize(t,n,!1),T?.setPixelRatio(y.getPixelRatio()),T?.setSize(t,n)),x.aspect=t/Math.max(1,n),x.updateProjectionMatrix()}je();let Me=new ResizeObserver(()=>je());Me.observe(m.parentElement??m),window.addEventListener(`resize`,je),window.visualViewport?.addEventListener(`resize`,je);function I(e,t,n,r,i){let a=Math.sin(d.time*n+r)*t,o=1-Math.exp(-14*i),s=(t,n)=>{let r=e.getObjectByName(t);r&&(r.rotation.x+=(n-r.rotation.x)*o)};s(`legL`,a),s(`legR`,-a),s(`armL`,-a*1.15),s(`armR`,a*1.15)}function Ne(e,t){let n=me.find(n=>!n.visible&&n.userData.kind===e&&n.userData.armed===t);return n||(n=Ll(e,t),me.push(n),b.add(n)),n.visible=!0,n}function Pe(e){F.position.set(d.player.x,0,d.player.z);let t=-Math.sin(d.player.yaw),n=-Math.cos(d.player.yaw);F.lookAt(d.player.x+t,0,d.player.z+n),F.rotateZ(-d.player.lean);let r=Math.min(1,d.player.speed/6),i=1+Math.sin(d.time*14)*r*.1;F.scale.set(1.06/i,i,1),I(F,r*1.05,11,0,e);let a=F.getObjectByName(`plate`),o=F.getObjectByName(`helm`),s=F.getObjectByName(`beanie`),c=F.getObjectByName(`poncho`),l=F.getObjectByName(`star`),u=d.armor===`suit`;a&&(a.visible=d.armor===`plate`||d.armor===`star`),c&&(c.visible=d.armor===`poncho`),l&&(l.visible=d.armor===`star`||u),o&&(o.visible=u),s&&(s.visible=!u);let f=F.userData.parka;f&&f.color.setHex(u?2375283:d.armor===`poncho`?15778126:14711346);let p=F.getObjectByName(`weapon`);if(p&&ye!==d.weapon){for(;p.children.length;)p.remove(p.children[0]);p.add(Bl(d.weapon)),ye=d.weapon}let m=F.getObjectByName(`offhand`);m&&!be&&(m.add(zl()),be=!0),m&&(m.visible=d.shieldOn);let h=d.weapon!==`pick`&&d.weapon!==`lasso`,g=F.getObjectByName(`armL`),_=F.getObjectByName(`armR`);if(g&&_&&(h?(g.rotation.x=.95,g.rotation.y=-.75,g.rotation.z=.9,_.rotation.x-=d.recoil*.5):(g.rotation.y=0,g.rotation.z=0,_.rotation.x-=d.recoil*.28)),p){let e=Math.sin(d.time*(r>.2?12:2.4))*(r>.2?.035:.018);p.position.set(h?.08:.02,-.34+e,.18-d.recoil*.2),p.rotation.set(-.2-d.recoil*.85,h?-.15:0,Math.sin(d.time*1.6)*.04)}de.visible=d.holding>0&&d.phase===`play`,de.position.set(d.player.x,.08,d.player.z),de.scale.setScalar(d.holdRadius)}function Fe(e){ce.forEach((t,n)=>{let r=n===d.miners&&d.minerFall>0;t.visible=n<d.miners||r,t.position.y=Math.sin(d.time*2.2+n)*.04,r&&(t.rotation.z=(1-d.minerFall)*1.2),t.visible&&I(t,.35,3.2,n,e)});for(let t of le){let n=d.folkDead.has(t.id);if(t.mesh.visible=!n,n)continue;if(t.mesh.lookAt(d.player.x,.9,d.player.z),t.tag.lookAt(x.position),d.deputies.has(t.id)&&!t.mesh.userData.gun){let e=Bl(`revolver`);e.scale.setScalar(.65),e.position.set(.02,-.34,.14),t.mesh.getObjectByName(`armR`)?.add(e),t.mesh.userData.gun=e}let r=d.nearId===t.id,i=r?1.05+Math.sin(d.time*8)*.04:1;t.mesh.scale.setScalar(.92*i),I(t.mesh,r?.45:.15,r?6:2,t.x,e)}ue.forEach(t=>{let n=t.x+Math.cos(d.time*.35+t.phase)*1.3,r=t.z+Math.sin(d.time*.28+t.phase)*1.1;t.mesh.position.set(n,Math.abs(Math.sin(d.time*3+t.phase))*.08,r),t.mesh.lookAt(n+Math.sin(d.time*.35+t.phase),.8,r+Math.cos(d.time*.35+t.phase)),I(t.mesh,.7,5,t.phase,e)});for(let e of P)e.lookAt(x.position)}function L(e){let t=new Set;for(let n of d.enemies){if(!n.alive)continue;t.add(n.id);let r=pe.get(n.id);r||(r=Ne(n.kind,n.armed),pe.set(n.id,r));let i=n.kind===`leaper`?Math.abs(Math.sin(d.time*7+n.id))*1.35:n.kind===`sidewinder`?Math.abs(Math.sin(d.time*6+n.id))*.7:Math.abs(Math.sin(d.time*10+n.id))*.12;r.position.set(n.x,i,n.z);let a=u[n.path]??u[0];r.lookAt(n.huntX??a[Math.min(n.waypoint,a.length-1)].x,i+.4,n.huntZ??a[Math.min(n.waypoint,a.length-1)].z);let o=r.userData.base||1,s=1+Math.sin(d.time*(n.kind===`leaper`?14:10)+n.id)*.16;r.scale.set(o*1.08/s,o*s,o);let c=r.userData.bodyMat;c.emissive.setHex(n.flash>0?16777215:0),c.emissiveIntensity=n.flash>0?.65:0;let l=r.userData.legs,f=r.userData.arms,p=Math.sin(d.time*(n.kind===`leaper`?16:9)+n.id),m=1-Math.exp(-12*e);l.forEach((e,t)=>{let n=p*(t%2==0?1.05:-1.05);e.rotation.x+=(n-e.rotation.x)*m}),f.forEach((e,t)=>{let n=p*(t%2==0?-1.2:1.2);e.rotation.x+=(n-e.rotation.x)*m});let h=r.userData.bar,g=Math.max(.05,n.hp/n.maxHp);h.scale.x=g,h.position.x=(g-1)*.32,h.material.color.setHex(g<.35?14747136:3120708)}for(let[e,n]of pe)if(!t.has(e)){for(let e=0;e<5;e++){let t=new Y(ve,Q([14747136,16765184,1929192,3120708,16774888][e]));t.position.copy(n.position),t.position.y+=.8,b.add(t),_e.push({mesh:t,life:.45,v:new W((Math.random()-.5)*4,2+Math.random()*3,(Math.random()-.5)*4)})}n.visible=!1,pe.delete(e)}}function Ie(){let e=new Set;for(let t of d.towers){e.add(t.pad);let n=he.get(t.pad);(!n||n.userData.type!==t.type)&&(n&&b.remove(n),n=Rl(t.type),n.userData.type=t.type,he.set(t.pad,n),b.add(n)),n.position.set(t.x,0,t.z);let r=Math.sin(d.time*2+t.pad)*.03;n.rotation.z=r;let i=n.getObjectByName(`turret`);i&&i.lookAt(t.aimX,n.userData.height??3,t.aimZ)}for(let[t,n]of he)e.has(t)||(b.remove(n),he.delete(t));let t=0,r=0,i=0;if(d.selected!=null&&d.phase!==`title`){let e=s[d.selected],a=d.towers.find(e=>e.pad===d.selected),o=a?.type??d.ghost;e&&o&&(t=a?c(o,a.trickLvl):n[o].range,r=e.x,i=e.z)}fe.visible=t>0,t>0&&(fe.position.set(r,.12,i),fe.scale.setScalar(t))}function R(){let e=new Set;for(let t of d.pickups){if(!t.alive)continue;e.add(t.id);let n=ge.get(t.id);n||(n=new vn,n.add(t.kind===`franklin`?Ul():Wl()),ge.set(t.id,n),b.add(n));let r=.55+Math.sin(d.time*4+t.id)*.16;n.position.set(t.x,r,t.z),n.rotation.y=d.time*2.2+t.id,n.rotation.z=Math.sin(d.time*3+t.id)*.3}for(let[t,n]of ge)e.has(t)||(b.remove(n),ge.delete(t))}function z(e){if(d.spray.id!==Se){Se=d.spray.id;let e=_?Math.min(8,Math.max(4,d.spray.n)):Math.min(16,Math.max(8,d.spray.n));for(let t=0;t<e;t++){let e=Ul();e.position.set(d.spray.x,1.15+Math.random()*.4,d.spray.z),b.add(e),Ce.push({mesh:e,life:1.15+Math.random()*.4,vy:3.2+Math.random()*2.4,vx:(Math.random()-.5)*5.5,vz:(Math.random()-.5)*5.5})}}d.earned>xe&&d.phase===`play`&&d.spray.id,xe=d.earned;for(let t=Ce.length-1;t>=0;t--){let n=Ce[t];n.life-=e,n.vy-=e*3,n.mesh.position.x+=n.vx*e,n.mesh.position.y+=n.vy*e,n.mesh.position.z+=n.vz*e,n.mesh.rotation.x+=e*6,n.life<=0&&(b.remove(n.mesh),Ce.splice(t,1))}for(let t=_e.length-1;t>=0;t--){let n=_e[t];n.life-=e,n.v.y-=e*8,n.mesh.position.addScaledVector(n.v,e),n.mesh.scale.setScalar(Math.max(.2,n.life*2)),n.life<=0&&(b.remove(n.mesh),_e.splice(t,1))}}function Le(){let e=0;for(let t of d.shots){if(!t.alive)continue;let n=we[e];n||(n=new Y(Te,new Mi({color:16777215,roughness:.3,metalness:.2,emissive:2236962})),b.add(n),we[e]=n),n.visible=!0,n.position.set(t.x,t.y,t.z),n.material.color.setHex(t.color),n.material.emissive.setHex(t.color),n.scale.setScalar(t.hostile?.7:t.splash>0?1.5:.8),e++}for(;e<we.length;e++)we[e].visible=!1}function Re(){let e=0;for(let t of d.fxPool){if(t.life<=0)continue;let n=Ee[e];n||(n=new Y(new bi(.25,8,6),new Mr({color:16777215,transparent:!0,opacity:1})),Ee[e]=n,b.add(n)),n.visible=!0;let r=t.life/t.max;n.position.set(t.x,t.y,t.z),n.scale.setScalar(t.kind===`boom`?(1-r)*2.4+.3:.4);let i=n.material;i.color.setHex(t.color),i.opacity=Math.max(0,r),e++}for(;e<Ee.length;e++)Ee[e].visible=!1}function ze(e){let t=-Math.sin(d.camYaw),n=-Math.cos(d.camYaw),r=Math.cos(d.camYaw),i=-Math.sin(d.camYaw),a=Math.abs(d.player.x)<5.6&&Math.abs(d.player.z)<4.6,o=a?8.4:11.4,s=2.2,c=(a?9.4:7.3)-d.camPitch*.35;S.set(d.player.x-t*o+r*s,c,d.player.z-n*o+i*s),C.set(d.player.x+t*1.5,1.35,d.player.z+n*1.5),d.snapCam?(x.position.copy(S),d.snapCam=!1):x.position.lerp(S,1-Math.exp(-11*e));let l=d.shake*.18;w.set(Math.sin(d.time*47)*l,Math.cos(d.time*37)*l*.5,0),x.position.add(w),x.lookAt(C)}let Be=!1;function Ve(e){let t=d.time*.12;S.set(Math.sin(t)*16,12,Math.cos(t)*16-6),C.set(0,1.5,0),Be?x.position.lerp(S,1-Math.exp(-1.1*e)):(x.position.copy(S),Be=!0),x.lookAt(C)}function He(){let e=m.getBoundingClientRect();d.qaKeys==null&&d.mouseAim&&!d.coarseAim&&e.width>0&&e.height>0?(Oe.x=(d.mouseX-e.left)/e.width*2-1,Oe.y=-((d.mouseY-e.top)/e.height)*2+1):Oe.set(0,0),De.setFromCamera(Oe,x),De.ray.intersectPlane(Ae,ke)&&(d.aimX=ke.x,d.aimZ=ke.z,d.hasAim=!0)}return{sync(e){if(je(),Pe(e),Fe(e),L(e),Ie(),R(),z(e),Le(),Re(),se?.ready){se.step(e);for(let e of se.bricks){let t=oe.get(e.id);t&&(t.position.set(e.x,e.y,e.z),t.quaternion.set(e.qx,e.qy,e.qz,e.qw))}}_||(D.position.set(d.player.x+16,28,d.player.z+8),D.target.position.set(d.player.x,0,d.player.z),D.target.updateMatrixWorld()),d.phase===`title`?Ve(e):ze(e),He(),T?T.render():y.render(b,x)},dispose(){Me.disconnect(),window.removeEventListener(`resize`,je),window.visualViewport?.removeEventListener(`resize`,je),T?.dispose(),y.dispose()}}}export{nu as createView};