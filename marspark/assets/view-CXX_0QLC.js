...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vo(e,t,n){return new ki({name:`SphericalGaussianBlur`,defines:{SAMPLES:no,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function yo(){return new ki({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bo(){return new ki({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xo(),fragmentShader:`
	...
	`}var So=class extends Rt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ai(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},yl=class extends ml{constructor(){super(vl)}setSize(e,t){this.material.uniforms.resolution.value.set(1/e,1/t)}},bl={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},xl=class extends ul{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ei.clone(bl.uniforms),this.material=new Ai({name:bl.name,uniforms:this.uniforms,vertexShader:bl.vertexShader,fragmentShader:bl.fragmentShader}),this._fsQuad=new pl(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},q.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Sl=class extends ul{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new J}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Cl=new Map;function Q(e){let t=Cl.get(e);return t||(t=new ji({color:e,roughness:.32,metalness:.08}),Cl.set(e,t)),t}function wl(e){return new ji({color:e,roughness:.32,metalness:.08,emissive:new J(0)})}function $(e,t,n=!0){let r=new Y(e,t);return r.castShadow=n,r.receiveShadow=n,r}function Tl(e,t,n,r=!0){return $(new di(e,t,2,8),n,r)}function El(e,t=.26){let n=Q(16776696),r=Q(1709844),i=Q(15769760);for(let i of[-.09,.09]){let a=$(new yi(.055,10,8),n,!1);a.position.set(i,.04,t);let o=$(new yi(.028,8,6),r,!1);o.position.set(i*1.05,.03,t+.04),e.add(a,o)}let a=$(new bi(.07,.016,6,12,Math.PI),r,!1);a.rotation.z=Math.PI,a.position.set(0,-.07,t+.01),e.add(a);for(let n of[-.16,.16]){let r=$(new yi(.04,8,6),i,!1);r.scale.set(1,.7,.4),r.position.set(n,-.02,t-.02),e.add(r)}}function Dl(e,t,n,r){let i=new gn;i.position.set(e,t,0);let a=$(new yi(.09,10,8),n,!1),o=Tl(.075,r,n);o.position.y=-r*.55-.06;let s=$(new yi(.09,8,6),n,!1);return s.scale.set(1.35,.55,1.55),s.position.y=-r-.12,i.add(a,o,s),i}function Ol(e,t,n){let r=new gn;r.position.set(e,t,0);let i=$(new yi(.08,8,6),n,!1),a=Tl(.06,.22,n);a.position.y=-.2;let o=$(new yi(.08,8,6),Q(15976353),!1);return o.position.y=-.38,r.add(i,a,o),r}function kl(e,t,n){let r=new gn;if(r.name=`hat`,e===`none`)return r;let i=Q(t);if(e===`cowboy`){let e=$(new pi(.34,.34,.05,16),i,!1);e.position.y=n;let t=$(new pi(.16,.18,.2,12),i,!1);t.position.y=n+.14,r.add(e,t)}else if(e===`top`){let e=$(new pi(.3,.3,.05,14),Q(1709844),!1);e.position.y=n;let t=$(new pi(.16,.16,.32,12),Q(1709844),!1);t.position.y=n+.2,r.add(e,t)}else{let e=$(new pi(.28,.3,.08,14),i,!1);e.position.y=n;let t=$(new yi(.08,8,6),i,!1);t.position.y=n+.16,r.add(e,t)}return r}function Al(){let e=new gn,t=wl(14711346),n=Q(1920649),r=Q(15976353),i=Dl(-.16,.62,n,.34),a=Dl(.16,.62,n,.34);i.name=`legL`,a.name=`legR`;let o=$(new pi(.28,.32,.52,14),t);o.position.y=.86,o.name=`torso`;let s=$(new pi(.08,.08,.08,8),r,!1);s.position.y=1.16;let c=Ol(-.38,1.02,t),l=Ol(.38,1.02,t);c.name=`armL`,l.name=`armR`;let u=$(new yi(.32,18,14),r);u.position.y=1.42,u.name=`head`,El(u,.26);let d=kl(`cap`,1929192,1.68);d.name=`beanie`;let f=$(new ui(.62,.36,.4),Q(12887412));f.name=`plate`,f.position.set(0,.88,.04),f.visible=!1;let p=new gn;p.name=`poncho`;let m=$(new ui(.86,.08,.62),Q(14747136));m.position.y=1.08,m.rotation.x=.35;let h=$(new ui(.88,.04,.16),Q(16774888),!1);h.position.set(0,1.1,.08),h.rotation.x=.35,p.add(m,h),p.visible=!1;let g=$(new gi(.11,0),Q(16765184),!1);g.scale.set(1,1,.35),g.name=`star`,g.position.set(.14,.98,.28),g.visible=!1;let _=kl(`top`,1709844,1.7);_.name=`helm`,_.visible=!1;let v=new gn;v.name=`weapon`,v.position.set(.02,-.36,.16),l.add(v);let y=new gn;return y.name=`offhand`,y.position.set(-.02,-.36,.12),c.add(y),e.add(i,a,o,s,c,l,u,d,f,p,g,_),e.userData.parka=t,e.userData.base=1,e}var jl=[14747136,1929192,3120708,16765184,8014773,12876338,15759922,4030153],Ml=[1929192,14747136,3120708,16765184,1709844,8014773,12876338,7027242];function Nl(e,t,n){let r=new gn,i=Q(t??jl[e%jl.length]),a=Q(2375283),o=Q(15976353),s=Dl(-.13,.52,a,.28),c=Dl(.13,.52,a,.28);s.name=`legL`,c.name=`legR`;let l=$(new pi(.22,.26,.42,12),i);l.position.y=.72;let u=Ol(-.3,.86,i),d=Ol(.3,.86,i);u.name=`armL`,d.name=`armR`;let f=$(new yi(.26,14,12),o);return f.position.y=1.16,f.name=`head`,El(f,.21),r.add(s,c,l,u,d,f,kl(`cowboy`,n??Ml[e%Ml.length],1.36)),r.userData.base=.86,r.scale.setScalar(.86),r}function Pl(e){let t=document.createElement(`canvas`);t.width=256,t.height=64;let n=t.getContext(`2d`);if(!n)return new gn;n.fillStyle=`#fff6e8`,n.fillRect(0,0,256,64),n.strokeStyle=`#1a1714`,n.lineWidth=8,n.strokeRect(4,4,248,56),n.fillStyle=`#1a1714`,n.font=`800 28px Arial Black, Arial, sans-serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(e,128,34);let r=new oi(t),i=new Y(new _i(1.15,.3),new jr({map:r,transparent:!0,side:2}));return i.name=`tag`,i.position.y=1.85,i}function Fl(e){let t=$(new ui(.7,.07,.04),Q(1709844),!1);t.position.y=e;let n=$(new ui(.64,.045,.05),Q(3120708),!1);return n.position.y=e,n.name=`hp`,{back:t,bar:n}}function Il(e,t){let n=new gn,r=[],i=[],a=wl(12887412),o=1,s=Q(15976353),c=(e,t,o=!1)=>{a=wl(e);let c=$(new pi(o?.2:.26,o?.24:.3,o?.62:.48,12),a);c.position.y=o?.95:.78;let l=$(new yi(o?.28:.26,14,12),s);l.position.y=o?1.48:1.22,El(l,o?.23:.21);let u=kl(`cowboy`,t,o?1.7:1.42),d=Dl(o?-.12:-.14,o?.62:.52,Q(3814704),o?.42:.3),f=Dl(o?.12:.14,o?.62:.52,Q(3814704),o?.42:.3),p=Ol(o?-.28:-.34,o?1.1:.92,a),m=Ol(o?.28:.34,o?1.1:.92,a);r.push(d,f),i.push(p,m);let h=Fl(o?2.05:1.7);n.add(c,l,u,d,f,p,m,h.back,h.bar),n.userData.bar=h.bar};if(e===`boss`){a=wl(16773590);let e=$(new yi(.62,16,12),a);e.position.y=1.05,e.scale.set(1.15,.95,1);let t=$(new yi(.34,14,12),s);t.position.y=1.85,El(t,.28);let c=$(new ui(.12,.4,.06),Q(14747136),!1);c.position.set(0,.9,.5);let l=Ol(-.7,1.15,a),u=Ol(.7,1.15,a),d=Dl(-.28,.55,Q(3814704),.36),f=Dl(.28,.55,Q(3814704),.36);r.push(d,f),i.push(l,u);let p=Fl(2.45);n.add(e,t,c,kl(`cowboy`,14747136,2.12),l,u,d,f,p.back,p.bar),n.userData.bar=p.bar,o=1.45}else e===`brute`?(c(7172730,1709844),o=1.25):e===`leaper`?(c(16765184,14747136,!0),o=1):e===`sidewinder`?(c(14747136,1709844,!0),o=1.05):e===`posse`?(c(12876338,7027242),o=1.05):c(12887412,7027242);if(t){let e=$(new ui(.08,.08,.36),Q(1709844),!1);e.position.set(.34,.85,.28),e.name=`gun`,n.add(e)}return n.userData.bodyMat=a,n.userData.legs=r,n.userData.arms=i,n.userData.kind=e,n.userData.armed=t,n.userData.base=o,n.scale.setScalar(o),n}function Ll(e){let t=d[e],n=new gn,r=t.height,i=$(new pi(.72,.85,.35,12),Q(12887412));i.position.y=.18;let a=$(new pi(.28,.38,r-.8,10),Q(t.color));a.position.y=r*.45;let o=$(new pi(.7,.7,.16,14),Q(16774888));o.position.y=r-.35;let s=new pi(.035,.035,.45,6);for(let e=0;e<6;e++){let t=e/6*Math.PI*2,i=$(s,Q(1709844),!1);i.position.set(Math.cos(t)*.58,r-.05,Math.sin(t)*.58),n.add(i)}let c=new gn;c.name=`turret`,c.position.y=r-.15;let l=e===`glue`?1929192:e===`confetti`?14747136:e===`disco`?16765184:2764340,u=$(new pi(.1,.12,.7,8),Q(l),!1);if(u.rotation.x=Math.PI/2,u.position.z=.35,c.add(u),e===`honk`){let e=$(new mi(.22,.4,8),Q(16765184),!1);e.rotation.x=Math.PI/2,e.position.z=.7,c.add(e)}if(e===`disco`){let e=$(new yi(.22,12,10),Q(16774888),!1);e.position.y=.35,c.add(e)}return n.add(i,a,o,c),n.userData.height=r,n}function Rl(){let e=new gn;e.name=`shield`;let t=$(new pi(.28,.3,.06,16),Q(12887412),!1);t.rotation.x=Math.PI/2;let n=$(new bi(.3,.03,6,16),Q(16765184),!1);n.rotation.x=Math.PI/2;let r=$(new yi(.06,8,6),Q(1709844),!1);return r.position.z=.04,e.add(t,n,r),e}function zl(e){let t=new gn;if(e===`pick`){let e=Tl(.045,.7,Q(7027242),!1);e.rotation.x=Math.PI/2,e.position.z=.2,t.add(e)}else if(e===`lasso`){let e=$(new bi(.22,.035,6,14),Q(14747136),!1);e.position.z=.35,t.add(e)}else if(e===`carbine`){let e=$(new ui(.1,.12,.72),Q(1929192),!1);e.position.z=.2,t.add(e)}else if(e===`revolver`){let e=$(new ui(.1,.12,.42),Q(12887412),!1);e.position.z=.16;let n=$(new ui(.08,.16,.1),Q(1709844),!1);n.position.set(0,-.12,.02),t.add(e,n)}else if(e===`dynamite`){let e=Tl(.07,.28,Q(14747136),!1);e.rotation.x=Math.PI/2,e.position.z=.2;let n=$(new pi(.02,.02,.16,6),Q(16765184),!1);n.position.set(.08,.08,.32),t.add(e,n)}else{let e=Tl(.1,.45,Q(3120708),!1);e.rotation.x=Math.PI/2,e.position.z=.25,t.add(e)}return t}function Bl(e,t,n){let r=document.createElement(`canvas`);r.width=t,r.height=n;let i=r.getContext(`2d`);if(!i)return null;e(i,t,n);let a=new oi(r);return a.colorSpace=qe,a.anisotropy=4,a}function Vl(){return Bl((e,t,n)=>{e.fillStyle=`#e7f6ea`,e.fillRect(0,0,t,n),e.strokeStyle=`#1a1714`,e.lineWidth=10,e.strokeRect(8,8,t-16,n-16),e.fillStyle=`#178a45`,e.font=`800 64px Arial Black, Arial, sans-serif`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(`100`,t/2,n/2-8),e.font=`700 22px Arial, sans-serif`,e.fillText(`MARSBUCK`,t/2,n/2+36)},256,128)}function Hl(){let e=Vl();return new Y(new _i(.62,.31),new ji({map:e??void 0,color:16777215,roughness:.6,metalness:0,side:2}))}function Ul(){let e=new gn;e.add($(new ui(.42,.36,.42),Q(12876338)));let t=$(new ui(.46,.08,.46),Q(16765184),!1);return t.position.y=.22,e.add(t),e}function Wl(e,t=1.4,n=.46){let r=Bl((t,n,r)=>{t.fillStyle=`#fff6e8`,t.fillRect(0,0,n,r),t.strokeStyle=`#1a1714`,t.lineWidth=12,t.strokeRect(8,8,n-16,r-16),t.fillStyle=`#e10600`,t.font=`800 42px Arial Black, Arial, sans-serif`,t.textAlign=`center`,t.textBaseline=`middle`,t.fillText(e,n/2,r/2+2)},256,96);return new Y(new _i(t,n),new jr({map:r??void 0,color:16777215,side:2}))}function Gl(e,t){return Bl((n,r,i)=>{n.fillStyle=e,n.fillRect(0,0,r,i);for(let e=0;e<80;e++)n.fillStyle=`rgba(255,255,255,0.05)`,n.fillRect(Math.random()*r,Math.random()*i,18,8);n.strokeStyle=`rgba(26,23,20,0.35)`,n.lineWidth=8;for(let e=0;e<3;e++)for(let t=0;t<2;t++){let r=40+t*110,i=36+e*90;n.fillStyle=`#9fd4ff`,n.fillRect(r,i,70,58),n.strokeRect(r,i,70,58),n.beginPath(),n.moveTo(r+35,i),n.lineTo(r+35,i+58),n.moveTo(r,i+29),n.lineTo(r+70,i+29),n.stroke()}n.fillStyle=`#fff6e8`,n.fillRect(r/2-90,18,180,40),n.strokeRect(r/2-90,18,180,40),n.fillStyle=`#1a1714`,n.font=`800 28px Arial Black, Arial, sans-serif`,n.textAlign=`center`,n.fillText(t,r/2,46)},512,512)}function Kl(e){return`#${e.toString(16).padStart(6,`0`)}`}function ql(e){let t=new gn;if(e.shape===`vault`){let n=$(new ui(e.hw*2,e.h,e.hd*2),Q(e.color));n.position.y=e.h/2;let r=$(new pi(.55,.55,.12,16),Q(16765184));r.rotation.x=Math.PI/2,r.position.set(0,e.h*.55,-(e.hd+.04));let i=$(new bi(.22,.05,6,12),Q(1709844),!1);i.position.set(0,e.h*.55,-(e.hd+.12));let a=$(new ui(e.hw*2+.2,.16,e.hd*2+.2),Q(e.roof));a.position.y=e.h+.05,t.add(n,r,i,a)}else if(e.shape===`bunker`){let n=$(new ui(e.hw*2,e.h,e.hd*2),Q(e.color));n.position.y=e.h/2;let r=$(new ui(e.hw*2+.15,.16,e.hd*2+.15),Q(2380328));r.position.y=e.h+.02;let i=$(new ui(e.hw*1.2,.12,.08),Q(1709844),!1);i.position.set(0,e.h*.62,e.hd+.02),t.add(n,r,i)}else if(e.shape===`wall`){let n=$(new ui(e.hw*2,e.h,e.hd*2),Q(e.color));n.position.y=e.h/2;let r=$(new ui(e.hw*2+.12,.16,e.hd*2+.12),Q(e.roof));if(r.position.y=e.h+.02,t.add(n,r),e.sign){let n=Wl(e.sign,1.6,.48);n.position.set(0,e.h*.62,-(e.hd+.06)),n.rotation.y=Math.PI,t.add(n)}}else if(e.shape===`tank`){let n=$(new pi(e.hw,e.hw,e.h,16),Q(e.color));n.position.y=e.h/2;let r=$(new pi(e.hw+.15,e.hw+.15,.18,16),Q(16774888));r.position.y=e.h+.05,t.add(n,r)}else{let n=new ji({color:16777215,map:Gl(Kl(e.color),e.sign??`SHOP`)??void 0,roughness:.45,metalness:.04}),r=$(new ui(e.hw*2,e.h,e.hd*2),n);r.position.y=e.h/2;let i=$(new ui(e.hw*2+.4,.28,e.hd*2+.35),Q(e.roof));i.position.y=e.h+.1;let a=$(new ui(e.hw*2+.15,.1,e.hd*2+.12),Q(16774888),!1);a.position.y=e.h-.02,t.add(r,i,a)}return t.position.set(e.x,0,e.z),t}function Jl(){let e=new gn,t=Q(12887412);for(let n=0;n<3;n++){let r=Tl(.16,.28,t);r.rotation.z=Math.PI/2,r.position.set((n-1)*.34,.2+(n===1?.22:0),0),e.add(r)}return e}function Yl(){let e=new gn,t=Tl(.1,.4,Q(7027242));t.position.y=.4;let n=$(new mi(.7,1.1,8),Q(3120708));n.position.y=1.15;let r=$(new mi(.48,.85,8),Q(3981144));return r.position.y=1.85,e.add(t,n,r),e}function Xl(e,t){let n=new gn,r=$(new mi(e,t*.7,7),Q(12868146),!1);r.position.y=t*.28;let i=$(new mi(e*.45,t*.38,7),Q(16774888),!1);return i.position.y=t*.62,n.add(r,i),n}function Zl(){let e=new gn,t=Q(3120708),n=Tl(.22,1.1,t);n.position.y=.8;let r=Tl(.12,.45,t);return r.rotation.z=Math.PI/2,r.position.set(.4,1.05,0),e.add(n,r),e}function Ql(){return Bl((e,t,n)=>{e.fillStyle=`#f7fbff`,e.fillRect(0,0,t,n);for(let r=0;r<1400;r++){let r=Math.random();e.fillStyle=r>.7?`#d5e6f5`:`#ffffff`,e.beginPath(),e.arc(Math.random()*t,Math.random()*n,r>.85?3:1.4,0,Math.PI*2),e.fill()}},512,512)}function $l(){return Bl((e,t,n)=>{e.fillStyle=`#c4623c`,e.fillRect(0,0,t,n);for(let r=0;r<900;r++)e.fillStyle=Math.random()>.5?`#a84b2e`:`#e08a5c`,e.fillRect(Math.random()*t,Math.random()*n,4,3)},512,512)}function eu(){return new ki({side:1,depthWrite:!1,fog:!1,vertexShader:`
      varying vec3 vWorld;
      void main() {
    ...
    `})}function tu(p){let m=navigator.deviceMemory??8,h=navigator.hardwareConcurrency||8,g=window.matchMedia(`(pointer: coarse), (max-width: 900px)`).matches||h<=4||m<=4,_=g?1:1.35,v=new ol({canvas:p,antialias:!g,alpha:!1,depth:!0,stencil:!1,powerPreference:g?`low-power`:`high-performance`});v.setPixelRatio(Math.min(window.devicePixelRatio||1,_)),v.outputColorSpace=qe,v.toneMapping=4,v.toneMappingExposure=1.16,v.shadowMap.enabled=!g,v.shadowMap.type=1;let y=new po(v),b=y.fromScene(new sl,g?.2:.04).texture,x=new Tn;x.environment=b,x.background=new J(9067074),x.fog=new wn(13206618,11,34);let S=new pa(46,1,.12,72);S.position.set(0,12,-18);let C=new G,w=new G,T=new G,E=g?null:new _l(v);E&&(E.addPass(new Sl(x,S)),E.addPass(new yl),E.addPass(new xl));let D=new Y(new yi(220,g?16:28,g?10:16),eu());D.frustumCulled=!1,x.add(D),x.add(new ta(16774884,12081714,.85));let O=new va(16774365,2.35);O.position.set(18,32,10),O.castShadow=!g,g||(O.shadow.mapSize.set(1024,1024),O.shadow.camera.near=4,O.shadow.camera.far=70,O.shadow.camera.left=-22,O.shadow.camera.right=22,O.shadow.camera.top=22,O.shadow.camera.bottom=-22,O.shadow.bias=-35e-5),x.add(O,O.target);let ee=new va(10406911,g?.55:.38);if(ee.position.set(-16,12,-8),x.add(ee),!g){let e=new ha(16761466,3.4,18,1.5);e.position.set(0,2.7,-6.1),x.add(e);let t=new ha(10405119,2.4,9,1.7);t.position.set(0,2.4,.2),x.add(t)}let k=$l();k&&(k.wrapS=k.wrapT=f,k.repeat.set(10,10));let te=new Y(new fi(100,g?24:48),new ji({color:16777215,map:k??void 0,roughness:.92,metalness:0}));te.rotation.x=-Math.PI/2,te.position.y=-.03,te.receiveShadow=!0,x.add(te);let A=Ql();A&&(A.wrapS=A.wrapT=f,A.repeat.set(8,8));let j=new Y(new fi(c.r-.4,g?32:64),new ji({color:16777215,map:A??void 0,roughness:.72,metalness:.02}));j.rotation.x=-Math.PI/2,j.position.set(c.x,.01,c.z),j.receiveShadow=!0,x.add(j);let M=new Y(new fi(11.5,40),new ji({color:16771e3,roughness:.55,metalness:.04}));M.rotation.x=-Math.PI/2,M.position.y=.02,M.receiveShadow=!0,x.add(M);let N=new Y(new ui(o.hx*2-.9,.06,o.hz*2-.9),new ji({color:16045194,roughness:.48,metalness:.05}));N.position.y=.04,N.receiveShadow=!0,x.add(N);let ne=new Y(new yi(c.r,g?24:40,g?12:20,0,Math.PI*2,0,Math.PI/2),new ji({color:12970239,transparent:!0,opacity:.14,roughness:.05,metalness:.1,side:2,depthWrite:!1}));ne.scale.y=.7,x.add(ne);let re=new Y(new bi(c.r,.22,8,g?32:64),Q(12887412));re.rotation.x=Math.PI/2,re.position.y=.12,x.add(re);let ie=new ji({color:4869717,roughness:.8,metalness:.05}),ae=new Set;for(let e of s)for(let t=0;t<e.length-1;t++){let n=e[t],r=e[t+1],i=`${Math.round(n.x)},${Math.round(n.z)}:${Math.round(r.x)},${Math.round(r.z)}`;if(ae.has(i))continue;ae.add(i);let a=r.x-n.x,o=r.z-n.z,s=new Y(new ui(2.5,.05,Math.hypot(a,o)||1),ie);s.position.set((n.x+r.x)/2,.035,(n.z+r.z)/2),s.rotation.y=Math.atan2(a,o),s.receiveShadow=!0,x.add(s)}for(let e of l)x.add(ql(e));for(let e of t){let t=Jl();t.position.set(e.x,0,e.z),t.rotation.y=e.yaw,x.add(t)}for(let t of e){let e=new Y(new pi(.55,.62,.12,12),Q(16765184));e.position.set(t.x,.06,t.z),e.receiveShadow=!0,x.add(e)}for(let[e,t,n,r]of[[-48,-34,10,16],[52,-30,12,18],[-42,40,11,15],[48,38,10,17],[6,-54,13,18],[-10,52,11,14]]){let i=Xl(n,r);i.position.set(e,0,t),x.add(i)}for(let[e,t]of[[27,20],[-28,18],[24,-26],[-26,-22]]){let n=Yl();n.position.set(e,0,t),x.add(n)}for(let[e,t]of[[-40,12],[38,14],[32,-32],[-22,-40],[8,44],[-44,-14]]){let n=Zl();n.position.set(e,0,t),x.add(n)}let oe=[];for(let[e,t,n]of[[`DUSTPAN AVE`,7.6,-11.8],[`ALLEY PROMISE`,-8.4,12.2],[`COLLATERAL`,12.2,-8.2],[`IOU LANE`,-12.2,-8.6]]){let r=new Y(new pi(.06,.08,1.35,8),Q(7027242));r.position.set(t,.68,n),r.castShadow=!0;let i=Pl(e);i.position.set(t,1.55,n),oe.push(i),x.add(r,i)}let P=Al();x.add(P);let se=Array.from({length:10},(e,t)=>{let r=Nl(t),i=n(t);return r.position.set(i.x,0,i.z),r.lookAt(0,.8,0),x.add(r),r}),ce=a.map(e=>{let t=Nl(0,e.coat,e.hat);t.scale.setScalar(.92),t.position.set(e.x,0,e.z);let n=Pl(e.name);return t.add(n),x.add(t),{mesh:t,tag:n,...e}}),F=i.map((e,t)=>{let n=Nl(t+2);return x.add(n),{mesh:n,...e,phase:t*1.3}}),I=new Y(new vi(.92,1,28),new jr({color:3120708,transparent:!0,opacity:.45,side:2}));I.rotation.x=-Math.PI/2,I.visible=!1,x.add(I);let le=new Y(new vi(.96,1,48),new jr({color:14747136,transparent:!0,opacity:.35,side:2}));le.rotation.x=-Math.PI/2,le.visible=!1,x.add(le);let ue=new Map,de=[],fe=new Map,pe=new Map,me=[],he=new yi(.12,8,6),ge=null,_e=!1,ve=u.earned,ye=0,be=[],xe=[],Se=new yi(.14,8,8),Ce=[],we=new Ra,Te=new W,Ee=new G,De=new Cr(new G(0,1,0),-.85);function Oe(){let e=p.clientWidth||1,t=p.clientHeight||1;v.setSize(e,t,!1),E?.setPixelRatio(v.getPixelRatio()),E?.setSize(e,t),S.aspect=e/Math.max(1,t),S.updateProjectionMatrix()}Oe();let ke=new ResizeObserver(()=>Oe());ke.observe(p.parentElement??p);function Ae(e,t,n,r,i){let a=Math.sin(u.time*n+r)*t,o=1-Math.exp(-14*i),s=(t,n)=>{let r=e.getObjectByName(t);r&&(r.rotation.x+=(n-r.rotation.x)*o)};s(`legL`,a),s(`legR`,-a),s(`armL`,-a*1.15),s(`armR`,a*1.15)}function je(e,t){let n=de.find(n=>!n.visible&&n.userData.kind===e&&n.userData.armed===t);return n||(n=Il(e,t),de.push(n),x.add(n)),n.visible=!0,n}function L(e){P.position.set(u.player.x,0,u.player.z);let t=-Math.sin(u.player.yaw),n=-Math.cos(u.player.yaw);P.lookAt(u.player.x+t,0,u.player.z+n),P.rotateZ(-u.player.lean);let r=Math.min(1,u.player.speed/6),i=1+Math.sin(u.time*14)*r*.1;P.scale.set(1.06/i,i,1),Ae(P,r*1.05,11,0,e);let a=P.getObjectByName(`plate`),o=P.getObjectByName(`helm`),s=P.getObjectByName(`beanie`),c=P.getObjectByName(`poncho`),l=P.getObjectByName(`star`),d=u.armor===`suit`;a&&(a.visible=u.armor===`plate`||u.armor===`star`),c&&(c.visible=u.armor===`poncho`),l&&(l.visible=u.armor===`star`||d),o&&(o.visible=d),s&&(s.visible=!d);let f=P.userData.parka;f&&f.color.setHex(d?2375283:u.armor===`poncho`?15778126:14711346);let p=P.getObjectByName(`weapon`);if(p&&ge!==u.weapon){for(;p.children.length;)p.remove(p.children[0]);p.add(zl(u.weapon)),ge=u.weapon}let m=P.getObjectByName(`offhand`);m&&!_e&&(m.add(Rl()),_e=!0),m&&(m.visible=u.shieldOn);let h=u.weapon!==`pick`&&u.weapon!==`lasso`,g=P.getObjectByName(`armL`),_=P.getObjectByName(`armR`);if(g&&_&&(h?(g.rotation.x=.95,g.rotation.y=-.75,g.rotation.z=.9,_.rotation.x-=u.recoil*.5):(g.rotation.y=0,g.rotation.z=0,_.rotation.x-=u.recoil*.28)),p){let e=Math.sin(u.time*(r>.2?12:2.4))*(r>.2?.035:.018);p.position.set(h?.08:.02,-.34+e,.18-u.recoil*.2),p.rotation.set(-.2-u.recoil*.85,h?-.15:0,Math.sin(u.time*1.6)*.04)}I.visible=u.holding>0&&u.phase===`play`,I.position.set(u.player.x,.08,u.player.z),I.scale.setScalar(u.holdRadius)}function Me(e){se.forEach((t,n)=>{let r=n===u.miners&&u.minerFall>0;t.visible=n<u.miners||r,t.position.y=Math.sin(u.time*2.2+n)*.04,r&&(t.rotation.z=(1-u.minerFall)*1.2),t.visible&&Ae(t,.35,3.2,n,e)});for(let t of ce){let n=u.folkDead.has(t.id);if(t.mesh.visible=!n,n)continue;if(t.mesh.lookAt(u.player.x,.9,u.player.z),t.tag.lookAt(S.position),u.deputies.has(t.id)&&!t.mesh.userData.gun){let e=zl(`revolver`);e.scale.setScalar(.65),e.position.set(.02,-.34,.14),t.mesh.getObjectByName(`armR`)?.add(e),t.mesh.userData.gun=e}let r=u.nearId===t.id,i=r?1.05+Math.sin(u.time*8)*.04:1;t.mesh.scale.setScalar(.92*i),Ae(t.mesh,r?.45:.15,r?6:2,t.x,e)}F.forEach(t=>{let n=t.x+Math.cos(u.time*.35+t.phase)*1.3,r=t.z+Math.sin(u.time*.28+t.phase)*1.1;t.mesh.position.set(n,Math.abs(Math.sin(u.time*3+t.phase))*.08,r),t.mesh.lookAt(n+Math.sin(u.time*.35+t.phase),.8,r+Math.cos(u.time*.35+t.phase)),Ae(t.mesh,.7,5,t.phase,e)});for(let e of oe)e.lookAt(S.position)}function Ne(e){let t=new Set;for(let n of u.enemies){if(!n.alive)continue;t.add(n.id);let r=ue.get(n.id);r||(r=je(n.kind,n.armed),ue.set(n.id,r));let i=n.kind===`leaper`?Math.abs(Math.sin(u.time*7+n.id))*1.35:n.kind===`sidewinder`?Math.abs(Math.sin(u.time*6+n.id))*.7:Math.abs(Math.sin(u.time*10+n.id))*.12;r.position.set(n.x,i,n.z);let a=s[n.path]??s[0];r.lookAt(n.huntX??a[Math.min(n.waypoint,a.length-1)].x,i+.4,n.huntZ??a[Math.min(n.waypoint,a.length-1)].z);let o=r.userData.base||1,c=1+Math.sin(u.time*(n.kind===`leaper`?14:10)+n.id)*.16;r.scale.set(o*1.08/c,o*c,o);let l=r.userData.bodyMat;l.emissive.setHex(n.flash>0?16777215:0),l.emissiveIntensity=n.flash>0?.65:0;let d=r.userData.legs,f=r.userData.arms,p=Math.sin(u.time*(n.kind===`leaper`?16:9)+n.id),m=1-Math.exp(-12*e);d.forEach((e,t)=>{let n=p*(t%2==0?1.05:-1.05);e.rotation.x+=(n-e.rotation.x)*m}),f.forEach((e,t)=>{let n=p*(t%2==0?-1.2:1.2);e.rotation.x+=(n-e.rotation.x)*m});let h=r.userData.bar,g=Math.max(.05,n.hp/n.maxHp);h.scale.x=g,h.position.x=(g-1)*.32,h.material.color.setHex(g<.35?14747136:3120708)}for(let[e,n]of ue)if(!t.has(e)){for(let e=0;e<5;e++){let t=new Y(he,Q([14747136,16765184,1929192,3120708,16774888][e]));t.position.copy(n.position),t.position.y+=.8,x.add(t),me.push({mesh:t,life:.45,v:new G((Math.random()-.5)*4,2+Math.random()*3,(Math.random()-.5)*4)})}n.visible=!1,ue.delete(e)}}function Pe(){let t=new Set;for(let e of u.towers){t.add(e.pad);let n=fe.get(e.pad);(!n||n.userData.type!==e.type)&&(n&&x.remove(n),n=Ll(e.type),n.userData.type=e.type,fe.set(e.pad,n),x.add(n)),n.position.set(e.x,0,e.z);let r=Math.sin(u.time*2+e.pad)*.03;n.rotation.z=r;let i=n.getObjectByName(`turret`);i&&i.lookAt(e.aimX,n.userData.height??3,e.aimZ)}for(let[e,n]of fe)t.has(e)||(x.remove(n),fe.delete(e));let n=0,i=0,a=0;if(u.selected!=null&&u.phase!==`title`){let t=e[u.selected],o=u.towers.find(e=>e.pad===u.selected),s=o?.type??u.ghost;t&&s&&(n=o?r(s,o.trickLvl):d[s].range,i=t.x,a=t.z)}le.visible=n>0,n>0&&(le.position.set(i,.12,a),le.scale.setScalar(n))}function R(){let e=new Set;for(let t of u.pickups){if(!t.alive)continue;e.add(t.id);let n=pe.get(t.id);n||(n=new gn,n.add(t.kind===`franklin`?Hl():Ul()),pe.set(t.id,n),x.add(n));let r=.55+Math.sin(u.time*4+t.id)*.16;n.position.set(t.x,r,t.z),n.rotation.y=u.time*2.2+t.id,n.rotation.z=Math.sin(u.time*3+t.id)*.3}for(let[t,n]of pe)e.has(t)||(x.remove(n),pe.delete(t))}function Fe(e){if(u.spray.id!==ye){ye=u.spray.id;let e=g?Math.min(8,Math.max(4,u.spray.n)):Math.min(16,Math.max(8,u.spray.n));for(let t=0;t<e;t++){let e=Hl();e.position.set(u.spray.x,1.15+Math.random()*.4,u.spray.z),x.add(e),be.push({mesh:e,life:1.15+Math.random()*.4,vy:3.2+Math.random()*2.4,vx:(Math.random()-.5)*5.5,vz:(Math.random()-.5)*5.5})}}u.earned>ve&&u.phase===`play`&&u.spray.id,ve=u.earned;for(let t=be.length-1;t>=0;t--){let n=be[t];n.life-=e,n.vy-=e*3,n.mesh.position.x+=n.vx*e,n.mesh.position.y+=n.vy*e,n.mesh.position.z+=n.vz*e,n.mesh.rotation.x+=e*6,n.life<=0&&(x.remove(n.mesh),be.splice(t,1))}for(let t=me.length-1;t>=0;t--){let n=me[t];n.life-=e,n.v.y-=e*8,n.mesh.position.addScaledVector(n.v,e),n.mesh.scale.setScalar(Math.max(.2,n.life*2)),n.life<=0&&(x.remove(n.mesh),me.splice(t,1))}}function z(){let e=0;for(let t of u.shots){if(!t.alive)continue;let n=xe[e];n||(n=new Y(Se,new ji({color:16777215,roughness:.3,metalness:.2,emissive:2236962})),x.add(n),xe[e]=n),n.visible=!0,n.position.set(t.x,t.y,t.z),n.material.color.setHex(t.color),n.material.emissive.setHex(t.color),n.scale.setScalar(t.hostile?.7:t.splash>0?1.5:.8),e++}for(;e<xe.length;e++)xe[e].visible=!1}function B(){let e=0;for(let t of u.fxPool){if(t.life<=0)continue;let n=Ce[e];n||(n=new Y(new yi(.25,8,6),new jr({color:16777215,transparent:!0,opacity:1})),Ce[e]=n,x.add(n)),n.visible=!0;let r=t.life/t.max;n.position.set(t.x,t.y,t.z),n.scale.setScalar(t.kind===`boom`?(1-r)*2.4+.3:.4);let i=n.material;i.color.setHex(t.color),i.opacity=Math.max(0,r),e++}for(;e<Ce.length;e++)Ce[e].visible=!1}function Ie(e){let t=-Math.sin(u.camYaw),n=-Math.cos(u.camYaw),r=Math.cos(u.camYaw),i=-Math.sin(u.camYaw),a=Math.abs(u.player.x)<5.6&&Math.abs(u.player.z)<4.6,o=a?8.4:11.4,s=2.2,c=(a?9.4:7.3)-u.camPitch*.35;C.set(u.player.x-t*o+r*s,c,u.player.z-n*o+i*s),w.set(u.player.x+t*1.5,1.35,u.player.z+n*1.5),u.snapCam?(S.position.copy(C),u.snapCam=!1):S.position.lerp(C,1-Math.exp(-11*e));let l=u.shake*.18;T.set(Math.sin(u.time*47)*l,Math.cos(u.time*37)*l*.5,0),S.position.add(T),S.lookAt(w)}let Le=!1;function Re(e){let t=u.time*.12;C.set(Math.sin(t)*16,12,Math.cos(t)*16-6),w.set(0,1.5,0),Le?S.position.lerp(C,1-Math.exp(-1.1*e)):(S.position.copy(C),Le=!0),S.lookAt(w)}function ze(){let e=p.getBoundingClientRect();u.qaKeys==null&&u.mouseAim&&!u.coarseAim&&e.width>0&&e.height>0?(Te.x=(u.mouseX-e.left)/e.width*2-1,Te.y=-((u.mouseY-e.top)/e.height)*2+1):Te.set(0,0),we.setFromCamera(Te,S),we.ray.intersectPlane(De,Ee)&&(u.aimX=Ee.x,u.aimZ=Ee.z,u.hasAim=!0)}return{sync(e){L(e),Me(e),Ne(e),Pe(),R(),Fe(e),z(),B(),g||(O.position.set(u.player.x+16,28,u.player.z+8),O.target.position.set(u.player.x,0,u.player.z),O.target.updateMatrixWorld()),u.phase===`title`?Re(e):Ie(e),ze(),E?E.render():v.render(x,S)},dispose(){ke.disconnect(),E?.dispose(),y.dispose(),v.dispose()}}}export{tu as createView};